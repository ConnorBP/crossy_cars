...
fn query_flag_requested(query_name: &str, _native_env: &str) -> bool {
...
fn main() {
    ...
    if car_review {
        // Controlled visual-review harness: production car assets only, plus a
        // fixed neutral studio. No world, UI, audio, state, input or gameplay.
