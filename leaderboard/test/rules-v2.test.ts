...
const goldenPath = fileURLToPath(new URL("../../rules/roady-rules.v2.golden.json", import.meta.url));
...
describe("rules v2 SplitMix64 and schedule golden parity", () => {
...
describe("rules v2 canonical byte and hash parity", () => {
...
describe("rules v2 bigint RightOfWay arithmetic parity", () => {
