//! Deterministic, language-neutral v2 rules artifacts.
//!
...
use super::canonical::{
    CluckTerminal, ConductTerminal, Event, EventPayload, RIGHT_OF_WAY_SCORE_HMAC_GOLDEN_BASE64URL,
    RIGHT_OF_WAY_SCORE_HMAC_GOLDEN_HEX, RightOfWayTerminal, SessionHeader, chain_event,
    score_hmac_input, sha256, started_session_header, unstarted_session_header, worker_proof_input,
};
use super::*;
...
/// The immutable v2 mechanics and canonical-protocol manifest.
pub fn manifest_document() -> Value {
    json!({
        ...
        "ordinals": {
            ...
            "terminal_reasons": { "time_up": 1, "wrecked": 2 },
        ...
        "canonical_encoding": {
            ...
            "hash": "sha256",
            "domains": {
                "session": "roady.v2.session", "score": "roady.v2.score",
                "event": "roady.v2.event", "root": "roady.v2.root",
                "schedule": "roady.v2.schedule", "seed": "roady.v2.seed",
                "proof": "roady.v2.proof", "evidence": "roady.v2.evidence"
            },
            ...
            "same_ms_order": [
                ...
                "collections", "activations", "gameplay_kind_then_stable_id", "terminal"
            ],
            "payload_layouts": {
...
/// A strict schema: a v2 manifest is valid only when it equals this immutable
/// generated contract. This intentionally rejects additions as well as edits.
pub fn schema_document() -> Value {
    json!({
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        "$id": "https://roady.game/rules/roady-rules.v2.schema.json",
        "title": "Roady immutable gameplay and canonical protocol rules v2",
        "description": "The generated v2 manifest is an exact immutable contract.",
        "type": "object",
...
fn canonical_vectors() -> Value {
    ...
    let proof_key = b"roady-v2-test-proof-key";
    ...
    let score_key = b"roady-v2-test-client-key";
    ...
    assert_eq!(hex(&row_golden_input), RIGHT_OF_WAY_SCORE_HMAC_GOLDEN_HEX);
    assert_eq!(row_golden_hmac, RIGHT_OF_WAY_SCORE_HMAC_GOLDEN_BASE64URL);
    ...
    json!({
        "session": {
            "input": {
                ...
                "proof_key_utf8": "roady-v2-test-proof-key"
            },
            "output": {
        ...
        "score_hmac_right_of_way_contract_golden": {
            "input": {
                "key_utf8": "roady-v2-test-client-key", "category": RIGHT_OF_WAY_CATEGORY,
        ...
        "score_hmac_cluck_hunt": {
            "input": {
                "key_utf8": "roady-v2-test-client-key", "category": CLUCK_HUNT_CATEGORY,
...
fn pretty(document: &Value) -> String {
    serde_json::to_string_pretty(document).expect("v2 artifact is serializable") + "\n"
}
...
mod tests {
    ...
    #[test]
    fn local_hmac_and_base64_match_published_fixture() {
        let input = decode_hex(RIGHT_OF_WAY_SCORE_HMAC_GOLDEN_HEX);
        let output = base64url(&hmac_sha256(b"roady-v2-test-client-key", &input));
        assert_eq!(output, RIGHT_OF_WAY_SCORE_HMAC_GOLDEN_BASE64URL);
    }
